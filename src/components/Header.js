                ...
                <Navbar collapseOnSelect expand="lg" bg="light" variant="light" expanded={this.state.expanded}>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ml-auto">
                            <Nav.Link className="m-auto nav-link" href="https://drive.google.com/file/d/1T8CfhEW-WbSvh4YppH8e-2KLSQH_MZBr/view" target="_blank" onClick={() => this.setExpanded(false)}>Resume</Nav.Link>
